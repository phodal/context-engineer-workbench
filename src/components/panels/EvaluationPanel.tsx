...
export default function EvaluationPanel({ messages, trace, metrics }: EvaluationPanelProps) {
  ...
  return (
    <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white rounded p-2 border border-purple-100">
              ...
              <div className="text-lg font-bold text-purple-900">
                {formatDuration(metrics.firstTokenLatency)}
              </div>
            </div>
            <div className="bg-white rounded p-2 border border-purple-100">
              <div className="text-xs text-purple-600 font-medium">Total Time</div>
              <div className="text-lg font-bold text-purple-900">
                {formatDuration(metrics.totalLatency)}
              </div>
            </div>
            <div className="bg-white rounded p-2 border border-purple-100">
            ...
            <div className="bg-white rounded p-2 border border-purple-100">
              ...
              <div className="text-lg font-bold text-purple-900">
                {formatDuration(metrics.averageLatencyPerToken)}
              </div>
            </div>
          </div>
      ...
      {structuredOutputs.length > 0 && <StructuredOutputViewer outputs={structuredOutputs} />}
