...
export function generateMockDocuments(): MockDocument[] {
  return [
    ...
    },
    {
      ...
      content:
        'Machine learning is a subset of artificial intelligence that enables systems to learn from data without being explicitly programmed. It involves training models on datasets to recognize patterns and make predictions. Common machine learning tasks include classification, regression, clustering, and dimensionality reduction. Machine learning powers many modern applications including recommendation systems, image recognition, and natural language processing.',
    },
  ];
}
